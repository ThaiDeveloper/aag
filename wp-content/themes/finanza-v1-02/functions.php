<?php
	...
	*/
	...
	if( !function_exists('gdlr_add_meta_keys_to_revision') ){
		function gdlr_add_meta_keys_to_revision( $keys ) {
			$keys[] = 'above-sidebar';
			$keys[] = 'below-sidebar';
			$keys[] = 'content-with-sidebar';
			$keys[] = 'post-option';
			return $keys;
		}
	}
...
add_action( 'admin_bar_menu', 'ct_modify_admin_bar', 990 );

function ct_modify_admin_bar( $wp_admin_bar ){
	$args = array(
		'id'     => 'multilang',
		'title'  => 'Languages',
	);
