						...
						'options' => array(
							...
							'thumbnail-link' => array(
								...
								'options' => array(
                                    ...
                                    'post'=> __('Link to Post', 'gdlr-portfolio'),
                            ...
                            'thumbnail-post-id' => array(
                                'title' => __('Specify Post Id' , 'gdlr-portfolio'),
                                'type' => 'text',
                                'wrapper-class' => 'thumbnail-link-wrapper video-wrapper image-wrapper post-wrapper'
                            ),
		...
		function gdlr_register_portfolio_item( $page_builder = array() ){
			...
			$page_builder['content-item']['options']['portfolio'] = array(
				...
				'options'=>array_merge(gdlr_page_builder_title_option(true), array(					
					...
					'show-portfolio-tag'=> array(
						'title'=> __('Show Portfolio Tag' ,'gdlr-portfolio'),
						'type'=> 'checkbox',
						'default'=> 'enable',
